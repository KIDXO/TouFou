...
@property (nonatomic, readwrite) UIColor *selectionIndicatorColor UI_APPEARANCE_SELECTOR;

@property (nonatomic, readwrite) UIColor *countColor UI_APPEARANCE_SELECTOR;

@property (nonatomic, readwrite) UIColor *titleColor UI_APPEARANCE_SELECTOR;
